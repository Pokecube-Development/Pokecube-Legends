package pokecube.legends.worldgen.chunk;
...
public class ChunkGeneratorDistorted implements IChunkGenerator
{
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = BlockInit.DISTORCED_BLOCK.getDefaultState();
    ...
    protected static final IBlockState OTHER_BLOCK1 = BlockInit.DISTORCED_DIRT.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = BlockInit.DISTORCED_CRYSTAL.getDefaultState();
    ...
    private final WorldGenerator quartzGen = new WorldGenMinable(Blocks.QUARTZ_ORE.getDefaultState(), 14, BlockMatcher.forBlock(BlockInit.SPATIAN_BLOCK));
    private final WorldGenerator magmaGen = new WorldGenMinable(Blocks.MAGMA.getDefaultState(), 33, BlockMatcher.forBlock(BlockInit.OCEAN_BLOCK));
    ...
    public ChunkGeneratorDistorted(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.DISTORTED_PLACE);
        }
