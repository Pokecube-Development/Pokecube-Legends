...
public class ChunkGeneratorSpace implements IChunkGenerator
{
    ...
    protected static final IBlockState OTHER_BLOCK1 = BlockInit.TEMPORAL_CRYSTAL.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = BlockInit.TEMPORAL_STONE.getDefaultState();
    ...
    */
    private final WorldGenerator quartzGen = new WorldGenMinable(Blocks.QUARTZ_ORE.getDefaultState(), 14, BlockMatcher.forBlock(BlockInit.LEAVES_DESCONSTRUTED));
    private final WorldGenerator magmaGen = new WorldGenMinable(Blocks.MAGMA.getDefaultState(), 33, BlockMatcher.forBlock(BlockInit.PLANKS_DESCONSTRUTED));
    private final WorldGenBush brownMushroomFeature = new WorldGenBush(Blocks.BROWN_MUSHROOM);
    private final WorldGenBush redMushroomFeature = new WorldGenBush(Blocks.RED_MUSHROOM);
    private MapGenNetherBridge genNetherBridge = new MapGenNetherBridge();
    ...
    public ChunkGeneratorSpace(World world, boolean generate, long seed)
    {
        this.world = world;
