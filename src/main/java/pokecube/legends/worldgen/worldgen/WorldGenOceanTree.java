...
public class WorldGenOceanTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.OCEAN_BLOCK.getDefaultState();
	public static final IBlockState LEAF = BlockInit.SPATIAN_BLOCK.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenOceanTree() 
	{
		super(false);
		this.minHeight = 12;
	}
	...
	protected boolean canGrowInto(Block blockType)
	{
        ...
        return material == Material.AIR || material == Material.LEAVES || material == Material.GROUND || blockType == BlockInit.DISTORCED_DIRT || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
