package pokecube.legends.worldgen.worldgen;
...
public class WorldGenDesconstrutedTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.PLANKS_DESCONSTRUTED.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_DESCONSTRUTED.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenDesconstrutedTree() 
	{
		super(false);
		this.minHeight = 16;
	}
	...
	protected boolean canGrowInto(Block blockType)
	{
        ...
        return material == Material.AIR || material == Material.LEAVES || material == Material.GROUND || blockType == BlockInit.TEMPORAL_DIRT || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
